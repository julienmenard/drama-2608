export const en = {
  ...
  biometricDataMissing: 'Biometric login data is missing. Please sign in with your email and password, then re-enable biometric login in your profile settings.',
  biometricNoUserData: 'Please sign in with your email and password first, then enable biometric login in your profile settings.',
  biometricUnexpectedError: 'An unexpected error occurred. Please sign in with your email and password, then re-enable biometric login in your profile settings.',
  biometricAuthCancelled: 'Biometric authentication was cancelled. Please try again.',
  webauthnNotEnabled: 'Please sign in with your email and password first, then enable WebAuthn login in your profile settings.',
  webauthnCancelled: 'WebAuthn authentication was cancelled. Please try again.',
  webauthnFailed: 'WebAuthn authentication failed',
  biometricLoginEnabled: 'Biometric login has been enabled',
  biometricLoginDisabled: 'Biometric login has been disabled',
  webauthnLoginEnabled: 'WebAuthn login has been enabled',
  webauthnLoginDisabled: 'WebAuthn login has been disabled',
  faceIdLoginEnabled: 'Face ID login has been enabled',
  faceIdLoginDisabled: 'Face ID login has been disabled',
  touchIdLoginEnabled: 'Touch ID login has been enabled',
  touchIdLoginDisabled: 'Touch ID login has been disabled',
  failedToEnableBiometric: 'Failed to enable biometric login',
